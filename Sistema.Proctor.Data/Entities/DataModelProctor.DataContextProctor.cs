...
namespace Sistema.Proctor.Data.Entities
{
    ...
    public partial class DataContextProctor : DbContext
    {
        ...
        public virtual DbSet<Clasificacionsuc> Clasificacionsucs
        {
            get;
            set;
        }

        public virtual DbSet<EnsayoGranulometria> EnsayoGranulometrias
        {
            get;
            set;
        }

        public virtual DbSet<Granulometria> Granulometrias
        {
            get;
            set;
        }

        public virtual DbSet<Granulometriadetalle> Granulometriadetalles
        {
            get;
            set;
        }

        public virtual DbSet<Limitesatterberg> Limitesatterbergs
        {
            get;
            set;
        }

        public virtual DbSet<EnsayoLimite> EnsayoLimites
        {
            get;
            set;
        }

        public virtual DbSet<LimiteLiquido> LimiteLiquidos
        {
            get;
            set;
        }

        public virtual DbSet<LimitePlastico> LimitePlasticos
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.ClasificacionsucMapping(modelBuilder);
            this.CustomizeClasificacionsucMapping(modelBuilder);

            this.EnsayoGranulometriaMapping(modelBuilder);
            this.CustomizeEnsayoGranulometriaMapping(modelBuilder);

            this.GranulometriaMapping(modelBuilder);
            this.CustomizeGranulometriaMapping(modelBuilder);

            this.GranulometriadetalleMapping(modelBuilder);
            this.CustomizeGranulometriadetalleMapping(modelBuilder);

            this.LimitesatterbergMapping(modelBuilder);
            this.CustomizeLimitesatterbergMapping(modelBuilder);

            this.EnsayoLimiteMapping(modelBuilder);
            this.CustomizeEnsayoLimiteMapping(modelBuilder);

            this.LimiteLiquidoMapping(modelBuilder);
            this.CustomizeLimiteLiquidoMapping(modelBuilder);

            this.LimitePlasticoMapping(modelBuilder);
            this.CustomizeLimitePlasticoMapping(modelBuilder);
        ...
        private void ParametroMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Parametro>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Parametro>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
        ...
        private void UsuarioMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>().Property(x => x.Idusuario).HasColumnName(@"idusuario").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            ...
            modelBuilder.Entity<Usuario>().Property(x => x.AuthKey).HasColumnName(@"auth_key").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Usuario>().Property(x => x.AccessToken).HasColumnName(@"access_token").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
        ...
        private void EnsayoProctorMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EnsayoProctor>().Property(x => x.EnsayadoPor).HasColumnName(@"ensayado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoProctor>().Property(x => x.RevisadoPor).HasColumnName(@"revisado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoProctor>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoProctor>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
        ...
        private void EnsayoHumedadMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.CreatedBy).HasColumnName(@"created_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.CreatedAt).HasColumnName(@"created_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.UpdatedBy).HasColumnName(@"updated_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.UpdateAt).HasColumnName(@"update_at").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.EnsayadoPor).HasColumnName(@"ensayado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.RevisadoPor).HasColumnName(@"revisado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoHumedad>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
        ...
        private void ResultadoHumedadMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResultadoHumedad>().Property(x => x.CreatedBy).HasColumnName(@"created_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<ResultadoHumedad>().Property(x => x.CreatedAt).HasColumnName(@"created_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<ResultadoHumedad>().Property(x => x.UpdatedBy).HasColumnName(@"updated_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<ResultadoHumedad>().Property(x => x.UpdateAt).HasColumnName(@"update_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
        ...
        #region Clasificacionsuc Mapping

        private void ClasificacionsucMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Clasificacionsuc>().ToTable(@"clasificacionsucs", @"dicesa");
            modelBuilder.Entity<Clasificacionsuc>().Property(x => x.IdClasificacion).HasColumnName(@"IdClasificacion").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<Clasificacionsuc>().Property(x => x.IdMuestra).HasColumnName(@"IdMuestra").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(11, 0);
            modelBuilder.Entity<Clasificacionsuc>().Property(x => x.GrupoSUCS).HasColumnName(@"GrupoSUCS").HasColumnType(@"varchar").IsRequired().ValueGeneratedNever().HasMaxLength(10);
            modelBuilder.Entity<Clasificacionsuc>().Property(x => x.Descripcion).HasColumnName(@"Descripcion").HasColumnType(@"text").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Clasificacionsuc>().HasKey(@"IdClasificacion");
        }

        partial void CustomizeClasificacionsucMapping(ModelBuilder modelBuilder);

        #endregion

        #region EnsayoGranulometria Mapping

        private void EnsayoGranulometriaMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EnsayoGranulometria>().ToTable(@"ensayo_granulometria", @"dicesa");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.Idensayogranulometria).HasColumnName(@"idensayogranulometria").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.InformeNumero).HasColumnName(@"informe_numero").HasColumnType(@"varchar").IsRequired().ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.Idmuestra).HasColumnName(@"idmuestra").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.FechaIngreso).HasColumnName(@"fecha_ingreso").HasColumnType(@"date").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.DescripcionMaterial).HasColumnName(@"descripcion_material").HasColumnType(@"text").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.ProfundidadInicial).HasColumnName(@"profundidad_inicial").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.TamizSeparacion).HasColumnName(@"tamiz_separacion").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(250).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.FechaEmision).HasColumnName(@"fecha_emision").HasColumnType(@"date").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.MetodoMuestreo).HasColumnName(@"metodo_muestreo").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.FechaMuestreo).HasColumnName(@"fecha_muestreo").HasColumnType(@"date").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.FechaInicio).HasColumnName(@"fecha_inicio").HasColumnType(@"date").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.FechaFin).HasColumnName(@"fecha_fin").HasColumnType(@"date").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.CodigoIngreso).HasColumnName(@"codigo_ingreso").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.Metodo).HasColumnName(@"metodo").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.RealizadoEn).HasColumnName(@"realizado_en").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.CreatedBy).HasColumnName(@"created_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.CreatedAt).HasColumnName(@"created_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.UpdatedBy).HasColumnName(@"updated_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.UpdateAt).HasColumnName(@"update_at").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.EnsayadoPor).HasColumnName(@"ensayado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.RevisadoPor).HasColumnName(@"revisado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.ProfundidadFinal).HasColumnName(@"profundidad_final").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoGranulometria>().HasKey(@"Idensayogranulometria");
        }

        partial void CustomizeEnsayoGranulometriaMapping(ModelBuilder modelBuilder);

        #endregion

        #region Granulometria Mapping

        private void GranulometriaMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Granulometria>().ToTable(@"granulometria", @"dicesa");
            modelBuilder.Entity<Granulometria>().Property(x => x.IdGranulometria).HasColumnName(@"IdGranulometria").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<Granulometria>().Property(x => x.Idensayogranulometria).HasColumnName(@"idensayogranulometria").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(11, 0);
            modelBuilder.Entity<Granulometria>().Property(x => x.Arena).HasColumnName(@"Arena").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.Limo).HasColumnName(@"Limo").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.Arcilla).HasColumnName(@"Arcilla").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.Grava).HasColumnName(@"Grava").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.PesoInicial).HasColumnName(@"peso_inicial").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.RetenidoTamiz4).HasColumnName(@"retenido_tamiz_4").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.MaterialPasaTamiz4).HasColumnName(@"material_pasa_tamiz_4").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.PesoRepresentativo).HasColumnName(@"peso_representativo").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.PesoMuestraLuegoLavado).HasColumnName(@"peso_muestra_luego_lavado").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.PasaTamizPorLavado).HasColumnName(@"pasa_tamiz_por_lavado").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.PasaTamizPorTamizado).HasColumnName(@"pasa_tamiz_por_tamizado").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.CreatedBy).HasColumnName(@"created_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.CreatedAt).HasColumnName(@"created_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<Granulometria>().Property(x => x.UpdatedBy).HasColumnName(@"updated_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.UpdateAt).HasColumnName(@"update_at").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<Granulometria>().Property(x => x.EnsayadoPor).HasColumnName(@"ensayado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.RevisadoPor).HasColumnName(@"revisado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometria>().HasKey(@"IdGranulometria");
        }

        partial void CustomizeGranulometriaMapping(ModelBuilder modelBuilder);

        #endregion

        #region Granulometriadetalle Mapping

        private void GranulometriadetalleMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Granulometriadetalle>().ToTable(@"granulometriadetalle", @"dicesa");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.IdDetalle).HasColumnName(@"IdDetalle").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.IdGranulometria).HasColumnName(@"IdGranulometria").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(11, 0);
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.Tamiz).HasColumnName(@"Tamiz").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(20).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.TamanoMM).HasColumnName(@"TamanoMM").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.Retenido1).HasColumnName(@"Retenido1").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.Retenido2).HasColumnName(@"Retenido2").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.RetenidoPorcentaje).HasColumnName(@"RetenidoPorcentaje").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.RetenidoAcumulado).HasColumnName(@"RetenidoAcumulado").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().Property(x => x.PorcentajePasa).HasColumnName(@"PorcentajePasa").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Granulometriadetalle>().HasKey(@"IdDetalle");
        }

        partial void CustomizeGranulometriadetalleMapping(ModelBuilder modelBuilder);

        #endregion

        #region Limitesatterberg Mapping

        private void LimitesatterbergMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Limitesatterberg>().ToTable(@"limitesatterberg", @"dicesa");
            modelBuilder.Entity<Limitesatterberg>().Property(x => x.IdLimites).HasColumnName(@"IdLimites").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<Limitesatterberg>().Property(x => x.IdMuestra).HasColumnName(@"IdMuestra").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(11, 0);
            modelBuilder.Entity<Limitesatterberg>().Property(x => x.LL).HasColumnName(@"LL").HasColumnType(@"decimal").IsRequired().ValueGeneratedNever().HasPrecision(5, 2);
            modelBuilder.Entity<Limitesatterberg>().Property(x => x.LP).HasColumnName(@"LP").HasColumnType(@"decimal").IsRequired().ValueGeneratedNever().HasPrecision(5, 2);
            modelBuilder.Entity<Limitesatterberg>().Property(x => x.IP).HasColumnName(@"IP").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<Limitesatterberg>().HasKey(@"IdLimites");
        }

        partial void CustomizeLimitesatterbergMapping(ModelBuilder modelBuilder);

        #endregion

        #region EnsayoLimite Mapping

        private void EnsayoLimiteMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EnsayoLimite>().ToTable(@"ensayo_limites", @"dicesa");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.Idensayolimites).HasColumnName(@"idensayolimites").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.ProfundidadInicial).HasColumnName(@"profundidad_inicial").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.ProfundidadFinal).HasColumnName(@"profundidad_final").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.InformeNo).HasColumnName(@"informe_no").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.Muestra).HasColumnName(@"muestra").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.FechaIngreso).HasColumnName(@"fecha_ingreso").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.DescripcionMaterial).HasColumnName(@"descripcion_material").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.MuestraNo).HasColumnName(@"muestra_no").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.FechaEmision).HasColumnName(@"fecha_emision").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.MetodoMuestreo).HasColumnName(@"metodo_muestreo").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.FechaMuestreo).HasColumnName(@"fecha_muestreo").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.CodigoIngreso).HasColumnName(@"codigo_ingreso").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(255).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.FechaEnsayoInicio).HasColumnName(@"fecha_ensayo_inicio").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.FechaEnsayoFin).HasColumnName(@"fecha_ensayo_fin").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.PasaTamiz4).HasColumnName(@"pasa_tamiz_4").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.PasaTamiz10).HasColumnName(@"pasa_tamiz_10").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.PasaTamiz40).HasColumnName(@"pasa_tamiz_40").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.PasaTamiz200).HasColumnName(@"pasa_tamiz_200").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.CreatedBy).HasColumnName(@"created_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.CreatedAt).HasColumnName(@"created_at").HasColumnType(@"datetime").IsRequired().ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.UpdatedBy).HasColumnName(@"updated_by").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.UpdateAt).HasColumnName(@"update_at").HasColumnType(@"datetime").ValueGeneratedOnAdd().HasDefaultValueSql(@"current_timestamp()");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.EnsayadoPor).HasColumnName(@"ensayado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.RevisadoPor).HasColumnName(@"revisado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.VerificadoPor).HasColumnName(@"verificado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.AutorizadoPor).HasColumnName(@"autorizado_por").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.LimiteLiquido).HasColumnName(@"limite_liquido").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.LimitePlastico).HasColumnName(@"limite_plastico").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().Property(x => x.IndicePlasticidad).HasColumnName(@"indice_plasticidad").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<EnsayoLimite>().HasKey(@"Idensayolimites");
        }

        partial void CustomizeEnsayoLimiteMapping(ModelBuilder modelBuilder);

        #endregion

        #region LimiteLiquido Mapping

        private void LimiteLiquidoMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<LimiteLiquido>().ToTable(@"limite_liquido", @"dicesa");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.Idlimiteliquido).HasColumnName(@"idlimiteliquido").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.Idensayolimites).HasColumnName(@"idensayolimites").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.NumGolpes).HasColumnName(@"num_golpes").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(11, 0);
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.CodigoTara).HasColumnName(@"codigo_tara").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(250).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.PesoTara).HasColumnName(@"peso_tara").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.PesoTaraMuestraHumeda).HasColumnName(@"peso_tara_muestra_humeda").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.PesoTaraMuestraSeca).HasColumnName(@"peso_tara_muestra_seca").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.PesoMuestraSeca).HasColumnName(@"peso_muestra_seca").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.PesoAgua).HasColumnName(@"peso_agua").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.Humedad).HasColumnName(@"humedad").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().Property(x => x.Metodo).HasColumnName(@"metodo").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(50).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimiteLiquido>().HasKey(@"Idlimiteliquido");
        }

        partial void CustomizeLimiteLiquidoMapping(ModelBuilder modelBuilder);

        #endregion

        #region LimitePlastico Mapping

        private void LimitePlasticoMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<LimitePlastico>().ToTable(@"limite_plastico", @"dicesa");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.Idlimiteplastico).HasColumnName(@"idlimiteplastico").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(11, 0);
            modelBuilder.Entity<LimitePlastico>().Property(x => x.Idensayolimites).HasColumnName(@"idensayolimites").HasColumnType(@"int").ValueGeneratedOnAdd().HasPrecision(11, 0).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.CodigoTara).HasColumnName(@"codigo_tara").HasColumnType(@"varchar").ValueGeneratedOnAdd().HasMaxLength(50).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.PesoTara).HasColumnName(@"peso_tara").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.PesoTaraMuestraHumeda).HasColumnName(@"peso_tara_muestra_humeda").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.PesoTaraMuestraSeca).HasColumnName(@"peso_tara_muestra_seca").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.PesoMuestraSeca).HasColumnName(@"peso_muestra_seca").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.PesoAgua).HasColumnName(@"peso_agua").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(10, 3).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().Property(x => x.Humedad).HasColumnName(@"humedad").HasColumnType(@"decimal").ValueGeneratedOnAdd().HasPrecision(5, 2).HasDefaultValueSql(@"NULL");
            modelBuilder.Entity<LimitePlastico>().HasKey(@"Idlimiteplastico");
        }

        partial void CustomizeLimitePlasticoMapping(ModelBuilder modelBuilder);
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Muestra>().HasMany(x => x.Clasificacionsucs).WithOne(op => op.Muestra).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IdMuestra").IsRequired(true);
            modelBuilder.Entity<Muestra>().HasMany(x => x.EnsayoGranulometrias).WithOne(op => op.Muestra).HasForeignKey(@"Idmuestra").IsRequired(false);
            modelBuilder.Entity<Muestra>().HasMany(x => x.Limitesatterbergs).WithOne(op => op.Muestra).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IdMuestra").IsRequired(true);
            ...
            modelBuilder.Entity<Clasificacionsuc>().HasOne(x => x.Muestra).WithMany(op => op.Clasificacionsucs).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IdMuestra").IsRequired(true);

            modelBuilder.Entity<EnsayoGranulometria>().HasOne(x => x.Muestra).WithMany(op => op.EnsayoGranulometrias).HasForeignKey(@"Idmuestra").IsRequired(false);
            modelBuilder.Entity<EnsayoGranulometria>().HasMany(x => x.Granulometrias).WithOne(op => op.EnsayoGranulometria).HasForeignKey(@"Idensayogranulometria").IsRequired(true);

            modelBuilder.Entity<Granulometria>().HasOne(x => x.EnsayoGranulometria).WithMany(op => op.Granulometrias).HasForeignKey(@"Idensayogranulometria").IsRequired(true);
            modelBuilder.Entity<Granulometria>().HasMany(x => x.Granulometriadetalles).WithOne(op => op.Granulometria).OnDelete(DeleteBehavior.Restrict).HasForeignKey(@"IdGranulometria").IsRequired(true);

            modelBuilder.Entity<Granulometriadetalle>().HasOne(x => x.Granulometria).WithMany(op => op.Granulometriadetalles).OnDelete(DeleteBehavior.Restrict).HasForeignKey(@"IdGranulometria").IsRequired(true);

            modelBuilder.Entity<Limitesatterberg>().HasOne(x => x.Muestra).WithMany(op => op.Limitesatterbergs).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IdMuestra").IsRequired(true);

            modelBuilder.Entity<EnsayoLimite>().HasMany(x => x.LimiteLiquidos).WithOne(op => op.EnsayoLimite).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"Idensayolimites").IsRequired(false);
            modelBuilder.Entity<EnsayoLimite>().HasMany(x => x.LimitePlasticos).WithOne(op => op.EnsayoLimite).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"Idensayolimites").IsRequired(false);

            modelBuilder.Entity<LimiteLiquido>().HasOne(x => x.EnsayoLimite).WithMany(op => op.LimiteLiquidos).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"Idensayolimites").IsRequired(false);

            modelBuilder.Entity<LimitePlastico>().HasOne(x => x.EnsayoLimite).WithMany(op => op.LimitePlasticos).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"Idensayolimites").IsRequired(false);
        }
