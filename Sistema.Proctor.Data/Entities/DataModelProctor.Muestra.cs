...
namespace Sistema.Proctor.Data.Entities
{
    public partial class Muestra : INotifyPropertyChanging, INotifyPropertyChanged {
        ...
        private IList<EnsayoHumedad> _EnsayoHumedads;

        private IList<Clasificacionsuc> _Clasificacionsucs;

        private IList<EnsayoGranulometria> _EnsayoGranulometrias;

        private IList<Limitesatterberg> _Limitesatterbergs;

        public Muestra()
        {
            this._Ensayos = new List<Ensayo>();
            this._EnsayoHumedads = new List<EnsayoHumedad>();
            this._Clasificacionsucs = new List<Clasificacionsuc>();
            this._EnsayoGranulometrias = new List<EnsayoGranulometria>();
            this._Limitesatterbergs = new List<Limitesatterberg>();
            OnCreated();
        }
        ...
        public virtual IList<EnsayoHumedad> EnsayoHumedads
        {
            get
            {
                return this._EnsayoHumedads;
            }
            set
            {
                this._EnsayoHumedads = value;
            }
        }

        public virtual IList<Clasificacionsuc> Clasificacionsucs
        {
            get
            {
                return this._Clasificacionsucs;
            }
            set
            {
                this._Clasificacionsucs = value;
            }
        }

        public virtual IList<EnsayoGranulometria> EnsayoGranulometrias
        {
            get
            {
                return this._EnsayoGranulometrias;
            }
            set
            {
                this._EnsayoGranulometrias = value;
            }
        }

        public virtual IList<Limitesatterberg> Limitesatterbergs
        {
            get
            {
                return this._Limitesatterbergs;
            }
            set
            {
                this._Limitesatterbergs = value;
            }
        }
